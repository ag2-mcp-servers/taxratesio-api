...
<pre><code class="js">var taxrates_endpoint = 'tax/countrycode';
 ...
 """,
    tags=['tax_rate_retrieval'],
)
def tax_rates_by_country_code(
    domain: Optional[str] = None,
    country_code: Optional[str] = None,
    filter: Optional[str] = None,
    zip: Optional[str] = None,
    product_codes__: Optional[str] = Query(None, alias='product_codes[]'),
    province_: Optional[str] = Query(None, alias='province '),
...
@app.get(
    '/v3/tax/rates',
    description=""" <p>Get request. This method returns all tax rates configured on your account. Based on your country selection the endpoint will return all taxes for all countries. You can use the 'filter' parameter to narrow results to selected type of tax. Use 'zip' parameter when you have selected the United States.</p>
...
def all_tax_rates(
    ...
    product_code: Optional[str] = Query(None, alias='Product_code'),
):
    """
    All tax rates
    """
